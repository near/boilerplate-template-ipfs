...
const ExplainText = () => (
  <div className="mx-auto mb-8 p-8 max-w-sm rounded overflow-hidden bg-gray-200">
    <div className="divide-y divide-gray-300/50">
      <div className="space-y-6 text-base leading-7 text-gray-600">
        <p>This app is a frontend React boilerplate template including Next.js and Tailwind CSS</p>
        <p>Next steps:</p>
